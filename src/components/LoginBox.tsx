...
const KakaoBtnWrapper = styled.div`
  ...
  padding-bottom: 4vh;
`;
// {ticker:"", stockname:"",buy_date:"",buy_price:0,quantity:0,buy_total_price:0}
// {ticker:"", stockname:"",buy_date:"",buy_price:0,quantity:0,buy_total_price:0, sell_date:"",sell_price:0,sell_total_price:0,rate:0}
